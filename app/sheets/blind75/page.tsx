...
import problemsData from "@/src/data/blind75.json";
...
export default function Blind75Page() {
    ...
    const handleResetSheet = () => {
        const confirmed = window.confirm(
            "Are you sure you want to reset all progress for Blind 75? This action cannot be undone."
        );

        if (confirmed) {
            const problemIds = problems.map(p => p.id);
            clearSheetProgress("blind75", problemIds);
                ...
                <div className="mb-16 flex flex-col gap-8">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-zinc-900/50 px-3 py-1.5 text-xs font-medium text-zinc-300 w-fit backdrop-blur-sm shadow-lg transition-all hover:bg-zinc-800/50 hover:border-white/20">
                            ...
                            <span className="tracking-wide">Blind 75</span>
                        </div>
                        ...
                        <h1 className="text-5xl font-bold tracking-tight text-white sm:text-6xl leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-white to-zinc-400 bg-clip-text text-transparent">
                                Asked FAANG Questions
                            </span>
                        </h1>

                        {/* Description */}
                        <p className="max-w-2xl text-zinc-400 text-base leading-relaxed">
                            A curated list of 75 essential problems that cover the most common patterns asked in technical interviews at top tech companies.
                        </p>
                    </div>
